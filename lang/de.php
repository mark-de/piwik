...
$translations = array(
	...
	'General_ClickToChangePeriod' => 'Erneut klicken, um den Zeitraum zu ändern.',
	...
	'Actions_WidgetEntryPageTitles' => 'Eingangsseiten Titel',
	...
	'Actions_ColumnSearchResultsCount' => 'Anzahl Ergebnisse',
	...
	'Actions_ColumnNoResultKeyword' => 'Suchbegriffe ohne Ergebnisse',
	'Actions_ColumnSearches' => 'Suchen',
	...
	'API_TopLinkTooltip' => 'Greifen Sie auf die Webanalytikdaten über eine einfache API mit json, xml, usw. zu.',
	...
	'Feedback_TopLinkTooltip' => 'Teilen Sie uns Ihre Meinung mit oder fordern Sie professionellen Support an.',
	'Goals_Goals' => 'Ziele',
	...
	'Installation_SiteSetup' => 'Konfigurieren Sie die erste Webseite, welche über Piwik getrackt und analyisert werden soll:',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Piwik erfordert die mysqli Erweiterung, oder die PDO und pdo_mysql Erweiterung oder für Oracle-Datenbanksysteme die oci8 Erweiterung.',
	...
	'Installation_SystemCheckPhpPdoAndMysqliSite' => 'Weitere Informationen unter: <a style="color:red" href="http://php.net/pdo">PHP PDO</a> und <a style="color:red" href="http://php.net/mysqli">MYSQLI</a> <a style="color:red" href="http://www.php.net/manual/en/oci8.installation.php">PHP OCI8</a>.',
	...
	'Login_MailPasswordChangeBody' => 'Hallo %1$s, eine Passwortänderung von %2$s wurde eingeleitet. Um das neue Passwort zu bestätigen, besuchen Sie folgenden Link: %3$s Hinweis: Der Link ist nur 24 Stunden gültig. Vielen Dank, dass Sie Piwik verwenden!',
	...
	'Login_ResetPasswordInstructions' => 'Geben Sie ein neues Passwort für Ihren Benutzer ein.',
	...
	'UserCountry_HowToInstallGeoIPDatabases' => 'Woher bekomme ich die GeoIP Datenbanken?',
	...
	'UserCountry_PeclGeoIPNoDBDir' => 'Das PECL Modul sucht nach Datenbanken in %1$s, aber das Verzeichnis existiert nicht. Bitte erstellen Sie das Verzeichnis und fügen Sie GeoIP Datenbanken hinzu. Alternativ können Sie %2$s auf das richtige Verzeichnis in der php.ini Datei ändern.',
	'UserCountry_PeclGeoLiteError' => 'Ihre GeoIP Datenbank in %1$s heißt %2$s. Leider erkennt das PECL Modul die Datenbank mit diesem Namen nicht. Bitte benennen Sie die Datei um in %3$s.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Piwik hat versucht, den Standort einer bekannten IP (%1$s) zu bestimmen, aber der Server gab %2$s zurück. Wenn die Methode zu Standortbestimmung richtig eingerichtet wäre, würde %3$s zurückgegeben.',
	'UserCountry_CannotLocalizeLocalIP' => 'Die IP %s ist eine Lokale Adresse, deren Standort nicht bestimmt werden kann.',
	'UserCountry_HowToSetupGeoIP' => 'Genaue Standortbestimmung mit GeoIP einrichten',
	'UserCountry_HowToSetupGeoIPIntro' => 'Sie haben keine Methode zur genauen Standortbestimmung installiert. Dies ist ein nützliches Feature und ohne es wird der Standort ihrer Besucher ungenau bestimmt. So können Sie den Standort Ihrer Besucher genauer bestimmen:',
	'UserCountry_HowToSetupGeoIP_Step1' => 'Die GeoLite City Datenbank von %3$sMaxMind%4$s %1$sherunterladen%2$s.',
	'UserCountry_HowToSetupGeoIP_Step2' => 'Entpacken Sie diese Datei und kopieren Sie das Ergebnis %1$s in den %2$smisc%3$s Piwik Unterordner (dies kann per FTP oder SSH geschehen).',
	'UserCountry_HowToSetupGeoIP_Step3' => 'Laden Sie diese Seite neu. Die %1$sGeoIP (PHP)%2$s Implementierung wird dann als %3$sInstalliert%4$s angezeigt. Wählen Sie sie aus.',
	'UserCountry_HowToSetupGeoIP_Step4' => 'Und das war\'s! Sie haben Piwik so eingerichtet, dass GeoIP verwendet wird. Dadurch sehen Sie die Regionen und Städte Ihrer Besucher und die Länderinformationen sind genauer.',
	'UserCountry_getCountryDocumentation' => 'Dieser Bericht enthält, von welchen Ländern aus auf die Website zugegriffen wurde.',
	'UserCountry_getContinentDocumentation' => 'In diesem Bericht wird angezeigt, von welchen Kontinenten aus auf die Website zugegriffen wurde.',
	'UserCountry_getRegionDocumentation' => 'In diesem Bericht wird ausgewertet, von welchen Regionen aus auf die Website zugegriffen wurde.',
	'UserCountry_getCityDocumentation' => 'Dieser Bericht zeigt die Städte, von denen aus die Besucher auf die Website zugegriffen haben.',
	'UserCountry_GeoIPDocumentationSuffix' => 'Um Daten in diesem Bericht sehen zu können, müssen Sie GeoIP im Admin-Tab "Standortbestimmung" installieren. Die kommerziellen %1$sMaxmind%2$s GeoIP Datenbanken sind genauer als die kostenlosen. Um zu sehen, wie genau sie sind, klicken Sie %3$shier%4$s.',
	'UserCountry_OldGeoIPWarning' => 'Das alte GeoIP plugin wurde erkannt. GeoIP wurde inzwischen in den Kern von Piwik integriert und das Plugin ist veraltet. Die neuen Berichte für Regionen und Städte werden nicht angezeigt, solange dieses Plugin aktiviert ist. %1$sBitte deaktivieren Sie das Plugin%2$s and %3$srichten Sie GeoIP ein%4$s. Um Standortdaten zu alten Besuchen hinzuzufügen, nutzen Sie %5$sdieses Skript%6$s und %7$sberechnen Sie die Archive erneut%8$s.',
	'UserCountry_NoDataForGeoIPReport' => 'Es gibt keine Daten für diesen Bericht, weil keine Standortdaten verfügbar sind. Um die genaue Standortbestimmung einzurichten, ändern Sie die Einstellungen %1$shier%2$s. Um Standortdaten zu bestehenden Besuchen hinzuzufügen, nutzen Sie %3$sdieses Skript%4$s.',
	...
	'Widgetize_TopLinkTooltip' => 'Exportieren Sie Piwik Berichte als Widgets und binden Sie das Dashboard in Ihrer Applikation als iframe ein.',
	...
	'PDFReports_TopLinkTooltip' => 'Erstellen Sie E-Mail Berichte, um Piwik Statistiken automatisch an Ihre E-Mailadresse oder die eines Kunden zu senden!',
	...
	'Transitions_FromPreviousSiteSearchesInline' => '%s von der internen Suche',
	'Transitions_ToFollowingSiteSearches' => 'Interne Suche',
